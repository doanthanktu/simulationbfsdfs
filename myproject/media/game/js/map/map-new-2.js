...
export default class SceneMapNew2 extends Phaser.Scene {
    ...
    create() {
        ...
        // // Tạo nhân vật
        this.player = this.physics.add.sprite(50, 720, 'player' + i).setDepth(5);
    ...
    update() {
        ...
        if (!existingMark) {
            ...
            const markType = ['mark1', 'mark2', 'mark2','mark2','mark2','mark2', 'mark2'][this.currentMarkIndex];
            ...
            this.currentMarkIndex = (this.currentMarkIndex + 1) % 7;
        }
    }
}
